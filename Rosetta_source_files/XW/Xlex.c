...
main(argc, argv)
    ...
    char *argv[];
{
#define VERSION    	" Lexed "
#define CLASS_NAME 	"LexWin"

#define TOP_WINDOW	    "le_window"
#define STARTUP_WINDOW      "le_startup_window"

#define UID_PATH            "lexed.uid"
...
*/
    ...
    if (MrmFetchWidget(mrm_id, TOP_WINDOW, top_window, 
        ...
        XwuError ("Can't fetch le_window");
    }
