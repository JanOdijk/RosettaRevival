...
BEGIN
result := FALSE;
IF ( rec1.compformations = rec2.compformations ) THEN
...
IF ( rec1.advformation = rec2.advformation ) THEN
result := TRUE;
...
IF ( rec1.compformations = rec2.compformations ) THEN
IF ( rec1.affix = rec2.affix ) THEN
IF ( rec1.compform = rec2.compform ) THEN
IF ( rec1.req = rec2.req ) THEN
IF ( rec1.env = rec2.env ) THEN
IF ( rec1.class = rec2.class ) THEN
IF ( rec1.deixis = rec2.deixis ) THEN
...
IF ( rec1.prepkey = rec2.prepkey ) THEN
IF ( rec1.position = rec2.position ) THEN
...
END;
FUNCTION EQUAL_GENrecord
(rec1,rec2:LSDOMAINT_GENrecord):BOOLEAN;
VAR result:BOOLEAN;
BEGIN
result := FALSE;
result := TRUE;
EQUAL_GENrecord:= result
END;
...
END;
FUNCTION EQUAL_BIRRPREFrecord
(rec1,rec2:LSDOMAINT_BIRRPREFrecord):BOOLEAN;
VAR result:BOOLEAN;
BEGIN
result := FALSE;
IF ( rec1.heads = rec2.heads ) THEN
result := TRUE;
EQUAL_BIRRPREFrecord:= result
END;
...
IF ( rec1.req = rec2.req ) THEN
IF ( rec1.env = rec2.env ) THEN
IF ( rec1.plurforms = rec2.plurforms ) THEN
...
IF ( rec1.gender = rec2.gender ) THEN
IF ( rec1.animate = rec2.animate ) THEN
IF ( rec1.predpos = rec2.predpos ) THEN
IF ( rec1.NPhead = rec2.NPhead ) THEN
...
IF ( rec1.predpos = rec2.predpos ) THEN
IF ( rec1.NPhead = rec2.NPhead ) THEN
IF ( rec1.persprocase = rec2.persprocase ) THEN
result := TRUE;
...
END;
FUNCTION EQUAL_BPREFIXrecord
(rec1,rec2:LSDOMAINT_BPREFIXrecord):BOOLEAN;
VAR result:BOOLEAN;
BEGIN
result := FALSE;
IF ( rec1.heads = rec2.heads ) THEN
result := TRUE;
EQUAL_BPREFIXrecord:= result
END;
...
END;
FUNCTION EQUAL_THERErecord
(rec1,rec2:LSDOMAINT_THERErecord):BOOLEAN;
VAR result:BOOLEAN;
BEGIN
result := FALSE;
result := TRUE;
EQUAL_THERErecord:= result
END;
FUNCTION EQUAL_TOCATrecord
(rec1,rec2:LSDOMAINT_TOCATrecord):BOOLEAN;
VAR result:BOOLEAN;
BEGIN
result := FALSE;
result := TRUE;
EQUAL_TOCATrecord:= result
END;
...
IF ( rec1.ingform = rec2.ingform ) THEN
IF ( rec1.sform = rec2.sform ) THEN
...
IF ( rec1.subc = rec2.subc ) THEN
IF ( rec1.oblcontrol = rec2.oblcontrol ) THEN
...
IF ( rec1.thatdel = rec2.thatdel ) THEN
result := TRUE;
...
IF ( rec1.classes = rec2.classes ) THEN
IF ( rec1.headfound = rec2.headfound ) THEN
IF ( rec1.Scomplfound = rec2.Scomplfound ) THEN
...
IF ( rec1.prepobj2found = rec2.prepobj2found ) THEN
IF ( rec1.nppredfound = rec2.nppredfound ) THEN
IF ( rec1.adjppredfound = rec2.adjppredfound ) THEN
...
IF ( rec1.animate = rec2.animate ) THEN
IF ( rec1.poss = rec2.poss ) THEN
IF ( rec1.whcase = rec2.whcase ) THEN
IF ( rec1.number = rec2.number ) THEN
IF ( rec1.sexes = rec2.sexes ) THEN
result := TRUE;
...
BIRRPREF : result := equal_BIRRPREFrecord
(lss1^.ls^.BIRRPREFfield^,lss2^.ls^.BIRRPREFfield^);
...
GEN : result := equal_GENrecord
(lss1^.ls^.GENfield^,lss2^.ls^.GENfield^);
...
VARNP : result := equal_NPrecord
(lss1^.ls^.VARNPfield^,lss2^.ls^.VARNPfield^);
...
BPREFIX : result := equal_BPREFIXrecord
(lss1^.ls^.BPREFIXfield^,lss2^.ls^.BPREFIXfield^);
...
TOCAT : result := equal_TOCATrecord
(lss1^.ls^.TOCATfield^,lss2^.ls^.TOCATfield^);
...
THERE : result := equal_THERErecord
(lss1^.ls^.THEREfield^,lss2^.ls^.THEREfield^);
