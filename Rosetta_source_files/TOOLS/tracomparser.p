...
PROCEDURE tracomPARSER_Body(if1 : tracomDECL_pConnectionNode; var if2 : tracomDECL_plostree);
{*earley constants:} 
...
type 
     psurfgraphnodelist = ^tracomDECL_surfgraphnodelist;
     plossurfnodelist = ^lossurfnodelist;
     lossurfnodelist = record
				next:plossurfnodelist;
				arg:tracomDECL_surfgraphnodelist;
		       end;
     ...
     setofstrees =  record
			j:integer;
			first:tracomDECL_plostree;
			last:tracomDECL_plostree;
		    end;
     ...
     rulerec = record
			...
			completed:boolean;
			nextnodes:tracomDECL_surfgraphnodelist;
			nexttops:tracomDECL_syntcatset;
			nextcats:tracomDECL_syntcatset
	       end;
     item = record
			cat: tracomLANGSPEC_Category;
     ...
     reltreelist1 = record
			first:tracomDECL_prsnode;
			last:tracomDECL_prsnode
		   end;
     sentencelength = 0..maximumlength;
     grammarlength = 0..tracomRULES_maxrnr;
    
{*end earley types}

{*begin earley global variables:}
var la:tracomDECL_psnode;
    i:integer;
    IT:array[0..maximumlength] of setofitems;
    ST:array[0..maximumlength] of setofsetofstrees;
    imax:sentencelength;
    topcats:tracomDECL_syntcatset;
    initialitem:array[1..tracomRULES_maxrnr] of pitem;
    libint:integer;
...
procedure newrsnode(var p:tracomDECL_prsnode);
begin
   MEM_newdefault(loopholes.sizeof(tracomDECL_rsnode),loopholes.retype(p,MEM_ptr))
end;
...
procedure newlostree(var p:tracomDECL_plostree);
begin
   MEM_newdefault(loopholes.sizeof(tracomDECL_lostree),loopholes.retype(p,MEM_ptr))
end;
...
procedure newlossurfnode(var p:tracomDECL_plossurfgraphnode);
begin
   MEM_newdefault(loopholes.sizeof(tracomDECL_lossurfgraphnode),loopholes.retype(p,MEM_ptr))
end;
...
procedure taketree(var stree1: tracomDECL_psnode;var S1:setofstrees);
...
procedure appendtree(stree1:tracomDECL_psnode;var S1:setofstrees);
{*appends stree1 at the end! of S1, if stree1 <> nil,
 *else S1 is not changed.}
var plostree1: tracomDECL_plostree;
...
procedure appendnode(node1:tracomDECL_psurfgraphnode;var S1:tracomDECL_surfgraphnodelist);
{*puts node1 at the end! of S1, if node1 <> nil.}
var plossurfgraphnode1:tracomDECL_plossurfgraphnode;
...
procedure appendnodelist(S1:tracomDECL_surfgraphnodelist;var S2:tracomDECL_surfgraphnodelist);
...
procedure initnodelist(var S1:tracomDECL_surfgraphnodelist);
...
function stillnodes(var S1:tracomDECL_surfgraphnodelist):boolean;
{*is true iff S1 is empty, i.e. if not S1.first=nil}
begin
...
procedure takenode(var node1:tracomDECL_psurfgraphnode;var S1:tracomDECL_surfgraphnodelist);
...
procedure copynodelist(var S1:tracomDECL_surfgraphnodelist;var S2:tracomDECL_surfgraphnodelist);
...
procedure appendsurfnodelist(var S1:tracomDECL_surfgraphnodelist;
...
procedure takenodelist(var S1:tracomDECL_surfgraphnodelist;var L1:listofsurfnodelists);
begin
...
procedure appendreltree(stree1:tracomDECL_psnode;var RT1:reltreelist1;
                        sonnumber:tracomDECL_nodeid);
var prsnode1:tracomDECL_prsnode;
begin
newrsnode(prsnode1);
...
procedure searchgraph(graph1:tracomDECL_psurfgraph;var node1:tracomDECL_psurfgraphnode;
		var completed1:boolean;var nextnodes1:tracomDECL_surfgraphnodelist;
                var nexttops1:tracomDECL_syntcatset;var nextcats1:tracomDECL_syntcatset);
...
var nextnodes2:tracomDECL_surfgraphnodelist;
    result1,result2,result3,result4:tracomDECL_syntcatset;
    node2:tracomDECL_psurfgraphnode;
    cat1:tracomLANGSPEC_Category;
    completed2:boolean;
...
procedure searchorread(graph1:tracomDECL_psurfgraph;node2:tracomDECL_psurfgraphnode;
		var completed1:boolean;var nextnodes1:tracomDECL_surfgraphnodelist;
		var nexttops1:tracomDECL_syntcatset;var nextcats1:tracomDECL_syntcatset);
var node1:tracomDECL_psurfgraphnode;
begin
...
with item1^ do
	begin
	cat:=tracomGRAPHDEF_topcat(rnr1);
...
with item1^.ruleinfo do
	...
	searchorread(tracomDECL_surfgraph(rnr),nil,completed,
...
function sameitem(var item1:pitem;minpos:integer;node1:tracomDECL_psurfgraphnode;
...
function local(item1:pitem;stree1:tracomDECL_psnode;IT:setofitems):setofitems;
...
var nextnodes1:tracomDECL_surfgraphnodelist;
    node1:tracomDECL_psurfgraphnode;
    result:setofitems;
    rnr:integer;

function localsurfrule(item1:pitem;stree1:tracomDECL_psnode;node1:tracomDECL_psurfgraphnode):pitem;
var item2,item3,item4:pitem;
    n:tracomDECL_nodeid;
    rnr,rnr2:integer;
    parents1:setofitems;
    rnrset:array[0..tracomRULES_maxrnr] of boolean;
    adoptedsons1,adoptedsons2:setofsetofstrees;
    setofstrees1,setofstrees2:setofstrees;
    history1,history2:listofsurfnodelists;
    surfgraphnodelist1,surfgraphnodelist2:tracomDECL_surfgraphnodelist;

begin
tracomDECL_assignstatus(false);
n:=node1^.n;
rnr:=item1^.ruleinfo.rnr;
if tracomDECL_debug then write('->localsurfrule',rnr,'  idnr:',n);
tracomRULES_rule(rnr,n,stree1,la,loccond);
if tracomDECL_status then
	begin
	if tracomDECL_debug then writeln('status true');
	if item1^.minpos=item1^.curpos then
		{*mark parents of initial items}
		begin
		rnr2:=0;
		while rnr2<>tracomRULES_maxrnr do
			begin
			rnr2:=rnr2+1;
			rnrset[rnr2]:=false
			end;
	...
	if sameitem(item4,item1^.minpos,node1,IT)=false then
		...
		with item2^.ruleinfo do 
			...
			history:=history2;
			initnodelist(nextnodes);
			searchorread(tracomDECL_surfgraph(rnr),node1,
...
else begin localsurfrule:=nil; if tracomDECL_debug then writeln('status false') end
end;

begin{local}
if tracomDECL_debug then writeln('->local',item1^.ruleinfo.rnr,'  minpos:',item1^.minpos);
inititemlist(result);
if stree1^.cat in item1^.ruleinfo.nextcats then
	...
	rnr:=0;
	while rnr<>tracomRULES_maxrnr do
		begin
		rnr:=rnr+1;
...
var 
    node1:tracomDECL_psurfgraphnode;
    surfgraphnodelist1:tracomDECL_surfgraphnodelist;
    result:setofstrees;
    stree1:tracomDECL_psnode;
...
var S1:setofstrees;
    stree1,
    stree2 :tracomDECL_psnode;
    Sij : setofstrees;

procedure saversnodes(var RT:reltreelist1);
var prsnode1,prsnode2,prsnode3:tracomDECL_prsnode;

begin
prsnode1:=RT.first;
MEM_newdefault(loopholes.sizeof(tracomDECL_rsnode),loopholes.retype(prsnode2,MEM_ptr));
prsnode2^:=prsnode1^;
RT.first:=prsnode2;
while prsnode1<>RT.last do
	...
	MEM_newdefault(loopholes.sizeof(tracomDECL_rsnode),loopholes.retype(prsnode3,MEM_ptr));
        prsnode3^:=prsnode1^;
...
begin
if tracomDECL_debug then writeln('->finalsurfrule');
tracomDECL_assignstatus(false);
tracomDECL_assignnewtop(nil);
inittreelist(S1);
readS(maxpos1, maxpos1+1, Sij);
taketree(stree2, Sij);
tracomRULES_rule(rnr,Hfinal,nil,la,globcond);
if tracomDECL_status then
	begin
	saversnodes(RT1);
	while tracomDECL_newtop<>nil do
		begin
                newtop1:=tracomDECL_newtop;
		...
		tracomDECL_assignnewtop(newtop1^.next)
		end
	end;
finalsurfrule:=S1
end;
...
procedure globalsurfrule(var setofstrees1:setofstrees;
		var surfgraphnodelist1:tracomDECL_surfgraphnodelist;var RT1:reltreelist1;
							    var nsons:integer);
var stree1:tracomDECL_psnode;
    node1:tracomDECL_psurfgraphnode;
begin
if tracomDECL_debug then writeln('->globalsurfrule');
while stilltrees(setofstrees1) do
	...
	if tracomDECL_status then
		begin
		tracomDECL_assignstatus(false);
		tracomRULES_rule(rnr,node1^.n,stree1,la,globcond);
		nsons:=nsons+1;
...
begin{final}
if tracomDECL_debug then write('->final',item1^.ruleinfo.rnr);
inittreelist(result);
if item1^.ruleinfo.completed then
	...
	while stilltreelists(adoptedsons1) do
		...
		rnr:=item1^.ruleinfo.rnr;
		tracomRULES_rule(rnr,Hinit,nil,la,globcond);
		nsons:=0;
		tracomDECL_assignstatus(true);
		minpos:=item1^.minpos;
		maxpos:=item1^.curpos;
...
if stilltrees(result)=false then if tracomDECL_debug then writeln('status false');
final:=result
end;
...
while rnr<>tracomRULES_maxrnr do
	begin
	rnr:=rnr+1;
	if (tracomGRAPHDEF_topcat(rnr) in item1^.ruleinfo.nexttops) then
		begin
...
while stilltreelists(setofSij) do
	...
	while stilltrees(S1) do
		...
		if tracomDECL_debug then writeln('tree scanned');
		copyitemlist(I1,IT[i]);
   ...
   {**}        IF i > (lasterror + 10) THEN
   			...
   			begin
                        ...
                        while w<>127 do
                           begin
                           w:=w+1;
                           IF tracomLANGSPEC_scat(chr(w)) IN nextcats THEN
                              writeln('   ',chr(w))
                           end;
                        w:=0;
                        while w<>tracomLANGSPEC_Nrow do
                           begin
                           w:=w+1;
                           IF tracomLANGSPEC_wcat(w) IN nextcats THEN
                              BEGIN
                              tracomLANGSPEC_word(w,str);
                              writeln('   ',str)
                              END
                           end;
...
var list1:tracomDECL_psinglesegmlist;
    i,j:integer;
    stree1:tracomDECL_psnode;
    connode1,connode2:tracomDECL_pConnectionNode;
    Sij:setofstrees;
begin
...
if tracomDECL_debug then writeln('imax determined:',imax); 
while i<>imax+1 do
	begin
	{j:=i;
	while j<>imax do
   ...
   while connode1<>connode2 do
	...
	while list1<>nil do
		...
		stree1^.minpos:=i;stree1^.maxpos:=j;
                if tracomDECL_debug then writeln('input i,j:',i,j,'cat:',ord(stree1^.cat));
   		{*}{ if tracomDECL_debug then 
     		    begin
	...
	connode1:=connode1^.next
   	...
   	while list1<>nil do
		...
		stree1^.minpos:=i;stree1^.maxpos:=imax;
                if tracomDECL_debug then writeln('input i,j:',i,imax,'cat:',ord(stree1^.cat));
   		{*}{ if tracomDECL_debug then 
   		    begin
   	            if stree1^.cat=charstring then 
   		    writeln('charstring=',stree1^.charstringfield^.stringfield);
...
new(absent1);tracomdecl_assignabsent(absent1);
i:=0;
usedparentlistindices:=[];
while i<>tracomRULES_maxrnr do
   begin
   i:=i+1;
...
{initialize topcats}
topcats := [];
FOR i:=1 TO tracomRULES_maxrnr DO topcats := topcats + [tracomGRAPHDEF_topcat(i)];
...
if tracomDECL_debug then writeln('trees initialized');
initializeitems(imax);
if tracomDECL_debug then writeln('items initialized');
...
while i <> imax do
	begin
	if tracomDECL_debug then writeln(i);
