...
intequals15:=TRUE
                                                      ...
                                                      function intequals16(param:INTEGER):BOOLEAN;
begin
X1:=param;
intequals16:=TRUE
end;
                                                      function intequals17(param:INTEGER):BOOLEAN;
begin
X1:=param;
intequals17:=TRUE
end;
                                                      function intequals18(param:INTEGER):BOOLEAN;
begin
X1:=param;
intequals18:=TRUE
end;
                                                      function intequals19(param:INTEGER):BOOLEAN;
begin
X1:=param;
intequals19:=TRUE
end;
                                                      function intequals20(param:INTEGER):BOOLEAN;
begin
X1:=param;
intequals20:=TRUE
end;
                                                      function intequals21(param:INTEGER):BOOLEAN;
begin
X1:=param;
intequals21:=TRUE
end;
                                                      function intequals22(param:INTEGER):BOOLEAN;
begin
X1:=param;
intequals22:=TRUE
end;
                                                      function intequals23(param:INTEGER):BOOLEAN;
begin
X1:=param;
intequals23:=TRUE
end;
...
HILTREE_emptyNode(result1);
WITH lsps^ DO BEGIN
IF (X194SUPER = PRESENTDEIXIS                             )                                                      THEN BEGIN
resultelt.sembonus:=0;
 resultelt.R:=145;
 lips.rulenr:=145;
 resultelt.parameters.index:=-1;
...
HILTREE_emptyNode(result1);
WITH lsps^ DO BEGIN
IF (X194SUPER = PASTDEIXIS                                )                                                      THEN BEGIN
resultelt.sembonus:=0;
 resultelt.R:=134;
 lips.rulenr:=134;
 resultelt.parameters.index:=-1;
...
HILTREE_emptyNode(result1);
WITH lsps^ DO BEGIN
IF (X215SUPER = PRESENTDEIXIS                             )                                                      THEN BEGIN
resultelt.sembonus:=0;
 resultelt.R:=145;
 lips.rulenr:=145;
 resultelt.parameters.index:=-1;
...
HILTREE_emptyNode(result1);
WITH lsps^ DO BEGIN
IF (X215SUPER = PASTDEIXIS                                )                                                      THEN BEGIN
resultelt.sembonus:=0;
 resultelt.R:=134;
 lips.rulenr:=134;
 resultelt.parameters.index:=-1;
...
HILTREE_emptyNode(result1);
WITH lsps^ DO BEGIN
IF (X228SUPER = PRESENTDEIXIS                             )                                                      THEN BEGIN
resultelt.sembonus:=0;
 resultelt.R:=145;
 lips.rulenr:=145;
 resultelt.parameters.index:=-1;
...
HILTREE_emptyNode(result1);
WITH lsps^ DO BEGIN
IF (X228SUPER = PASTDEIXIS                                )                                                      THEN BEGIN
resultelt.sembonus:=0;
 resultelt.R:=134;
 lips.rulenr:=134;
 resultelt.parameters.index:=-1;
...
HILTREE_emptyNode(result1);
WITH lsps^ DO BEGIN
IF (X146VOICEPAR = ACTIVE                                 )                                                      THEN BEGIN
resultelt.sembonus:=0;
 resultelt.R:=14;
 lips.rulenr:=14;
 resultelt.parameters.index:=-1;
...
HILTREE_emptyNode(result1);
WITH lsps^ DO BEGIN
IF (X147VOICEPAR = PASSIVE                                )                                                      THEN BEGIN
resultelt.sembonus:=0;
 resultelt.R:=130;
 lips.rulenr:=130;
 resultelt.parameters.index:=-1;
...
HILTREE_emptyNode(result1);
WITH lsps^ DO BEGIN
IF (X148VOICEPAR = PASSIVE                                )                                                      THEN BEGIN
resultelt.sembonus:=0;
 resultelt.R:=130;
 lips.rulenr:=130;
 resultelt.parameters.index:=-1;
...
HILTREE_emptyNode(result1);
WITH lsps^ DO BEGIN
IF (intequals16(X74ANTECEDENT)                            ) AND (
X74MULTITUDEPAR = TRUE                                )                                                      THEN BEGIN
resultelt.sembonus:=0;
 resultelt.R:=165;
 lips.rulenr:=165;
 resultelt.parameters.index:=-1;
...
HILTREE_emptyNode(result1);
WITH lsps^ DO BEGIN
IF (intequals18(X74ANTECEDENT)                            ) AND (
X74MULTITUDEPAR = FALSE                               )                                                      THEN BEGIN
resultelt.sembonus:=0;
 resultelt.R:=164;
 lips.rulenr:=164;
 resultelt.parameters.index:=-1;
...
HILTREE_emptyNode(result1);
WITH lsps^ DO BEGIN
IF (intequals20(X74ANTECEDENT)                            ) AND (
X74MULTITUDEPAR = FALSE                               )                                                      THEN BEGIN
resultelt.sembonus:=0;
 resultelt.R:=165;
 lips.rulenr:=165;
...
HILTREE_emptyNode(result1);
WITH lsps^ DO BEGIN
IF (X41NUMBERPAR = SINGULAR                               )                                                      THEN BEGIN
resultelt.sembonus:=0;
 resultelt.R:=89;
 lips.rulenr:=89;
 resultelt.parameters.index:=-1;
...
HILTREE_emptyNode(result1);
WITH lsps^ DO BEGIN
IF (X41NUMBERPAR = PLURAL                                 )                                                      THEN BEGIN
resultelt.sembonus:=0;
 resultelt.R:=89;
 lips.rulenr:=89;
 resultelt.parameters.index:=-1;
...
resultelt.sembonus:=0;
 ...
 resultelt.parameters.subst:=ps.subst;
 resultelt.parameters.params:=lips;
 HILTREE_newhyperiltreerule(p,13,resultelt.parameters);
 HILTREE_storehypernodeelt(p,resultelt);
 HILTREE_AddToNode(p,result1);
appendresults(result1,result);
 END;
...
resultelt.sembonus:=0;
 ...
 resultelt.parameters.subst:=ps.subst;
 resultelt.parameters.params:=lips;
 HILTREE_newhyperiltreerule(p,125,resultelt.parameters);
 HILTREE_storehypernodeelt(p,resultelt);
 HILTREE_AddToNode(p,result1);
appendresults(result1,result);
 END;
...
resultelt.sembonus:=0;
 ...
 resultelt.parameters.subst:=ps.subst;
 resultelt.parameters.params:=lips;
 HILTREE_newhyperiltreerule(p,81,resultelt.parameters);
 HILTREE_storehypernodeelt(p,resultelt);
 HILTREE_AddToNode(p,result1);
appendresults(result1,result);
 END;
...
resultelt.sembonus:=0;
 ...
 resultelt.parameters.subst:=ps.subst;
 resultelt.parameters.params:=lips;
 HILTREE_newhyperiltreerule(p,202,resultelt.parameters);
 HILTREE_storehypernodeelt(p,resultelt);
 HILTREE_AddToNode(p,result1);
appendresults(result1,result);
 END;
...
resultelt.sembonus:=0;
 ...
 resultelt.parameters.subst:=ps.subst;
 resultelt.parameters.params:=lips;
 HILTREE_newhyperiltreerule(p,82,resultelt.parameters);
 HILTREE_storehypernodeelt(p,resultelt);
 HILTREE_AddToNode(p,result1);
appendresults(result1,result);
 END;
...
resultelt.sembonus:=0;
 ...
 resultelt.parameters.subst:=ps.subst;
 resultelt.parameters.params:=lips;
 HILTREE_newhyperiltreerule(p,188,resultelt.parameters);
 HILTREE_storehypernodeelt(p,resultelt);
 HILTREE_AddToNode(p,result1);
appendresults(result1,result);
 END;
...
resultelt.sembonus:=0;
 ...
 resultelt.parameters.subst:=ps.subst;
 resultelt.parameters.params:=lips;
 HILTREE_newhyperiltreerule(p,83,resultelt.parameters);
 HILTREE_storehypernodeelt(p,resultelt);
 HILTREE_AddToNode(p,result1);
appendresults(result1,result);
 END;
...
resultelt.sembonus:=0;
 ...
 resultelt.parameters.subst:=ps.subst;
 resultelt.parameters.params:=lips;
 HILTREE_newhyperiltreerule(p,119,resultelt.parameters);
 HILTREE_storehypernodeelt(p,resultelt);
 HILTREE_AddToNode(p,result1);
appendresults(result1,result);
 END;
...
resultelt.sembonus:=0;
 ...
 resultelt.parameters.subst:=ps.subst;
 resultelt.parameters.params:=lips;
 HILTREE_newhyperiltreerule(p,137,resultelt.parameters);
 HILTREE_storehypernodeelt(p,resultelt);
 HILTREE_AddToNode(p,result1);
appendresults(result1,result);
 END;
...
helpresult1:=result1;
HILTREE_emptyNode(result1);
 IF X251NUMBERPAR=SINGULAR THEN BEGIN
result2:=helpresult1;
...
HILTREE_addtoNode(p,result1);
 END;
END;
 IF X251NUMBERPAR=PLURAL THEN BEGIN
result2:=helpresult1;
WHILE NOT(HILTREE_IsEmptyNode(result2)) DO
 BEGIN
 HILTREE_TakeFromNode(p,result2);
...
helpresult1:=result1;
HILTREE_emptyNode(result1);
 IF X252NUMBERPAR=SINGULAR THEN BEGIN
result2:=helpresult1;
WHILE NOT(HILTREE_IsEmptyNode(result2)) DO
 BEGIN
 HILTREE_TakeFromNode(p,result2);
...
HILTREE_addtoNode(p,result1);
 END;
END;
 IF X252NUMBERPAR=PLURAL THEN BEGIN
result2:=helpresult1;
WHILE NOT(HILTREE_IsEmptyNode(result2)) DO
 BEGIN
 HILTREE_TakeFromNode(p,result2);
...
helpresult1:=result1;
HILTREE_emptyNode(result1);
 IF X203SUPERPAR=PRESENTDEIXIS THEN BEGIN
result2:=helpresult1;
WHILE NOT(HILTREE_IsEmptyNode(result2)) DO
 BEGIN
 HILTREE_TakeFromNode(p,result2);
...
HILTREE_addtoNode(p,result1);
 END;
END;
 IF X203SUPERPAR=PASTDEIXIS THEN BEGIN
result2:=helpresult1;
WHILE NOT(HILTREE_IsEmptyNode(result2)) DO
 BEGIN
 HILTREE_TakeFromNode(p,result2);
...
helpresult1:=result1;
HILTREE_emptyNode(result1);
 IF X419ADJUNCTPAR=RESAP THEN BEGIN
result2:=helpresult1;
WHILE NOT(HILTREE_IsEmptyNode(result2)) DO
 BEGIN
 HILTREE_TakeFromNode(p,result2);
...
HILTREE_addtoNode(p,result1);
 END;
END;
 IF X419ADJUNCTPAR=RESPP THEN BEGIN
result2:=helpresult1;
WHILE NOT(HILTREE_IsEmptyNode(result2)) DO
 BEGIN
 HILTREE_TakeFromNode(p,result2);
...
HILTREE_addtoNode(p,result1);
 END;
END;
 IF X419ADJUNCTPAR=SUBJCOMIT THEN BEGIN
result2:=helpresult1;
WHILE NOT(HILTREE_IsEmptyNode(result2)) DO
 BEGIN
 HILTREE_TakeFromNode(p,result2);
...
HILTREE_addtoNode(p,result1);
 END;
END;
 IF X419ADJUNCTPAR=OBJCOMIT THEN BEGIN
result2:=helpresult1;
WHILE NOT(HILTREE_IsEmptyNode(result2)) DO
 BEGIN
 HILTREE_TakeFromNode(p,result2);
...
HILTREE_addtoNode(p,result1);
 END;
END;
 IF X419ADJUNCTPAR=BENFACTNP THEN BEGIN
result2:=helpresult1;
WHILE NOT(HILTREE_IsEmptyNode(result2)) DO
 BEGIN
 HILTREE_TakeFromNode(p,result2);
...
HILTREE_addtoNode(p,result1);
 END;
END;
 IF X419ADJUNCTPAR=BENFACTPP THEN BEGIN
result2:=helpresult1;
WHILE NOT(HILTREE_IsEmptyNode(result2)) DO
 BEGIN
 HILTREE_TakeFromNode(p,result2);
...
HILTREE_addtoNode(p,result1);
 END;
END;
 IF X419ADJUNCTPAR=LOCADJUNCT THEN BEGIN
result2:=helpresult1;
WHILE NOT(HILTREE_IsEmptyNode(result2)) DO
 BEGIN
 HILTREE_TakeFromNode(p,result2);
...
HILTREE_addtoNode(p,result1);
 END;
END;
 IF X419ADJUNCTPAR=DIRADJUNCT THEN BEGIN
result2:=helpresult1;
WHILE NOT(HILTREE_IsEmptyNode(result2)) DO
 BEGIN
 HILTREE_TakeFromNode(p,result2);
...
HILTREE_addtoNode(p,result1);
 END;
END;
 IF X419ADJUNCTPAR=RESNP THEN BEGIN
result2:=helpresult1;
WHILE NOT(HILTREE_IsEmptyNode(result2)) DO
 BEGIN
 HILTREE_TakeFromNode(p,result2);
...
helpresult1:=result1;
HILTREE_emptyNode(result1);
 IF X420ADJUNCTPAR=RESAP THEN BEGIN
result2:=helpresult1;
WHILE NOT(HILTREE_IsEmptyNode(result2)) DO
 BEGIN
 HILTREE_TakeFromNode(p,result2);
...
HILTREE_addtoNode(p,result1);
 END;
END;
 IF X420ADJUNCTPAR=RESPP THEN BEGIN
result2:=helpresult1;
WHILE NOT(HILTREE_IsEmptyNode(result2)) DO
 BEGIN
 HILTREE_TakeFromNode(p,result2);
...
HILTREE_addtoNode(p,result1);
 END;
END;
 IF X420ADJUNCTPAR=SUBJCOMIT THEN BEGIN
result2:=helpresult1;
WHILE NOT(HILTREE_IsEmptyNode(result2)) DO
 BEGIN
 HILTREE_TakeFromNode(p,result2);
...
HILTREE_addtoNode(p,result1);
 END;
END;
 IF X420ADJUNCTPAR=OBJCOMIT THEN BEGIN
result2:=helpresult1;
WHILE NOT(HILTREE_IsEmptyNode(result2)) DO
 BEGIN
 HILTREE_TakeFromNode(p,result2);
...
HILTREE_addtoNode(p,result1);
 END;
END;
 IF X420ADJUNCTPAR=BENFACTNP THEN BEGIN
result2:=helpresult1;
WHILE NOT(HILTREE_IsEmptyNode(result2)) DO
 BEGIN
 HILTREE_TakeFromNode(p,result2);
...
HILTREE_addtoNode(p,result1);
 END;
END;
 IF X420ADJUNCTPAR=BENFACTPP THEN BEGIN
result2:=helpresult1;
WHILE NOT(HILTREE_IsEmptyNode(result2)) DO
 BEGIN
 HILTREE_TakeFromNode(p,result2);
...
HILTREE_addtoNode(p,result1);
 END;
END;
 IF X420ADJUNCTPAR=LOCADJUNCT THEN BEGIN
result2:=helpresult1;
WHILE NOT(HILTREE_IsEmptyNode(result2)) DO
 BEGIN
 HILTREE_TakeFromNode(p,result2);
...
HILTREE_addtoNode(p,result1);
 END;
END;
 IF X420ADJUNCTPAR=DIRADJUNCT THEN BEGIN
result2:=helpresult1;
WHILE NOT(HILTREE_IsEmptyNode(result2)) DO
 BEGIN
 HILTREE_TakeFromNode(p,result2);
...
HILTREE_addtoNode(p,result1);
 END;
END;
 IF X420ADJUNCTPAR=RESNP THEN BEGIN
result2:=helpresult1;
WHILE NOT(HILTREE_IsEmptyNode(result2)) DO
 BEGIN
 HILTREE_TakeFromNode(p,result2);
...
HILTREE_emptyNode(result1);
WITH lsps^ DO BEGIN
IF (X361SUPERPAR = PRESENTDEIXIS                          )                                                      THEN BEGIN
resultelt.sembonus:=0;
 resultelt.R:=145;
 lips.rulenr:=145;
 resultelt.parameters.index:=-1;
...
HILTREE_emptyNode(result1);
WITH lsps^ DO BEGIN
IF (X361SUPERPAR = PASTDEIXIS                             )                                                      THEN BEGIN
resultelt.sembonus:=0;
 resultelt.R:=134;
 lips.rulenr:=134;
 resultelt.parameters.index:=-1;
...
HILTREE_emptyNode(result1);
WITH lsps^ DO BEGIN
IF (X371SUPER = PRESENTDEIXIS                             )                                                      THEN BEGIN
resultelt.sembonus:=0;
 resultelt.R:=145;
 lips.rulenr:=145;
 resultelt.parameters.index:=-1;
...
HILTREE_emptyNode(result1);
WITH lsps^ DO BEGIN
IF (X371SUPER = PASTDEIXIS                                )                                                      THEN BEGIN
resultelt.sembonus:=0;
 resultelt.R:=134;
 lips.rulenr:=134;
 resultelt.parameters.index:=-1;
...
HILTREE_emptyNode(result1);
WITH lsps^ DO BEGIN
IF (X312SUPER = PRESENTDEIXIS                             )                                                      THEN BEGIN
resultelt.sembonus:=0;
 resultelt.R:=145;
 lips.rulenr:=145;
 resultelt.parameters.index:=-1;
...
HILTREE_emptyNode(result1);
WITH lsps^ DO BEGIN
IF (X312SUPER = PASTDEIXIS                                )                                                      THEN BEGIN
resultelt.sembonus:=0;
 resultelt.R:=134;
 lips.rulenr:=134;
 resultelt.parameters.index:=-1;
...
HILTREE_emptyNode(result1);
WITH lsps^ DO BEGIN
IF (X328SUPER = PRESENTDEIXIS                             )                                                      THEN BEGIN
resultelt.sembonus:=0;
 resultelt.R:=145;
 lips.rulenr:=145;
 resultelt.parameters.index:=-1;
...
HILTREE_emptyNode(result1);
WITH lsps^ DO BEGIN
IF (X328SUPER = PASTDEIXIS                                )                                                      THEN BEGIN
resultelt.sembonus:=0;
 resultelt.R:=134;
 lips.rulenr:=134;
 resultelt.parameters.index:=-1;
...
HILTREE_emptyNode(result1);
WITH lsps^ DO BEGIN
IF (intequals1(X337INDEXPAR)                              ) AND (
X337XPMOODPAR = RELATIVEXPMOOD                        )                                                      THEN BEGIN
resultelt.sembonus:=0;
 resultelt.R:=167;
 lips.rulenr:=167;
 resultelt.parameters.index:=-1;
...
HILTREE_emptyNode(result1);
WITH lsps^ DO BEGIN
IF (intequals8(X337INDEXPAR)                              ) AND (
X337XPMOODPAR = TOPICMOOD                             )                                                      THEN BEGIN
resultelt.sembonus:=0;
 resultelt.R:=190;
 lips.rulenr:=190;
 resultelt.parameters.index:=-1;
 resultelt.parameters.subst:=ps.subst;
 lips.X190INDEXPAR:=X1                                                    ;
 resultelt.parameters.params:=lips;
 HILTREE_newhyperiltreerule(p,190,resultelt.parameters);
 HILTREE_storehypernodeelt(p,resultelt);
 HILTREE_AddToNode(p,result1);
appendresults(result1,result);
 END;
...
HILTREE_emptyNode(result1);
WITH lsps^ DO BEGIN
IF (intequals2(X338INDEXPAR)                              ) AND (
X338XPMOODPAR = RELATIVEXPMOOD                        )                                                      THEN BEGIN
resultelt.sembonus:=0;
 resultelt.R:=167;
 lips.rulenr:=167;
 resultelt.parameters.index:=-1;
...
HILTREE_emptyNode(result1);
WITH lsps^ DO BEGIN
IF (intequals9(X338INDEXPAR)                              ) AND (
X338XPMOODPAR = TOPICMOOD                             )                                                      THEN BEGIN
resultelt.sembonus:=0;
 resultelt.R:=190;
 lips.rulenr:=190;
 resultelt.parameters.index:=-1;
...
HILTREE_emptyNode(result1);
WITH lsps^ DO BEGIN
IF (intequals3(X340INDEXPAR)                              ) AND (
X340XPMOODPAR = RELATIVEXPMOOD                        )                                                      THEN BEGIN
resultelt.sembonus:=0;
 resultelt.R:=167;
 lips.rulenr:=167;
 resultelt.parameters.index:=-1;
...
HILTREE_emptyNode(result1);
WITH lsps^ DO BEGIN
IF (intequals10(X340INDEXPAR)                             ) AND (
X340XPMOODPAR = TOPICMOOD                             )                                                      THEN BEGIN
resultelt.sembonus:=0;
 resultelt.R:=190;
 lips.rulenr:=190;
 resultelt.parameters.index:=-1;
...
HILTREE_emptyNode(result1);
WITH lsps^ DO BEGIN
IF (intequals4(X339INDEXPAR)                              ) AND (
X339XPMOODPAR = RELATIVEXPMOOD                        )                                                      THEN BEGIN
resultelt.sembonus:=0;
 resultelt.R:=167;
 lips.rulenr:=167;
 resultelt.parameters.index:=-1;
...
HILTREE_emptyNode(result1);
WITH lsps^ DO BEGIN
IF (intequals11(X339INDEXPAR)                             ) AND (
X339XPMOODPAR = TOPICMOOD                             )                                                      THEN BEGIN
resultelt.sembonus:=0;
 resultelt.R:=190;
 lips.rulenr:=190;
 resultelt.parameters.index:=-1;
...
HILTREE_emptyNode(result1);
WITH lsps^ DO BEGIN
IF (intequals5(X341INDEXPAR)                              ) AND (
X341XPMOODPAR = RELATIVEXPMOOD                        )                                                      THEN BEGIN
resultelt.sembonus:=0;
 resultelt.R:=167;
 lips.rulenr:=167;
 resultelt.parameters.index:=-1;
...
HILTREE_emptyNode(result1);
WITH lsps^ DO BEGIN
IF (intequals12(X341INDEXPAR)                             ) AND (
X341XPMOODPAR = TOPICMOOD                             )                                                      THEN BEGIN
resultelt.sembonus:=0;
 resultelt.R:=190;
 lips.rulenr:=190;
 resultelt.parameters.index:=-1;
...
HILTREE_emptyNode(result1);
WITH lsps^ DO BEGIN
IF (intequals6(X342INDEXPAR)                              ) AND (
X342XPMOODPAR = RELATIVEXPMOOD                        )                                                      THEN BEGIN
resultelt.sembonus:=0;
 resultelt.R:=167;
 lips.rulenr:=167;
 resultelt.parameters.index:=-1;
...
HILTREE_emptyNode(result1);
WITH lsps^ DO BEGIN
IF (intequals13(X342INDEXPAR)                             ) AND (
X342XPMOODPAR = TOPICMOOD                             )                                                      THEN BEGIN
resultelt.sembonus:=0;
 resultelt.R:=190;
 lips.rulenr:=190;
 resultelt.parameters.index:=-1;
...
HILTREE_emptyNode(result1);
WITH lsps^ DO BEGIN
IF (intequals22(X450CONTROLLERPAR)                        )                                                      THEN BEGIN
resultelt.sembonus:=0;
 resultelt.R:=117;
 lips.rulenr:=117;
 resultelt.parameters.index:=-1;
