...
HILTREE_emptyNode(result1);
WITH lsps^ DO BEGIN
IF (X216SUPER = PRESENTE                                  )                                                      THEN BEGIN
resultelt.sembonus:=0;
 resultelt.R:=145;
 lips.rulenr:=145;
 resultelt.parameters.index:=-1;
...
HILTREE_emptyNode(result1);
WITH lsps^ DO BEGIN
IF (X216SUPER = PASADO                                    )                                                      THEN BEGIN
resultelt.sembonus:=0;
 resultelt.R:=134;
 lips.rulenr:=134;
 resultelt.parameters.index:=-1;
...
HILTREE_emptyNode(result1);
WITH lsps^ DO BEGIN
IF (X224SUPER = PRESENTE                                  )                                                      THEN BEGIN
resultelt.sembonus:=0;
 resultelt.R:=145;
 lips.rulenr:=145;
 resultelt.parameters.index:=-1;
...
HILTREE_emptyNode(result1);
WITH lsps^ DO BEGIN
IF (X224SUPER = PASADO                                    )                                                      THEN BEGIN
resultelt.sembonus:=0;
 resultelt.R:=134;
 lips.rulenr:=134;
 resultelt.parameters.index:=-1;
...
HILTREE_emptyNode(result1);
WITH lsps^ DO BEGIN
IF (X128MODOPAR = INDICATIVO                              )                                                      THEN BEGIN
resultelt.sembonus:=0;
 resultelt.R:=72;
 lips.rulenr:=72;
 resultelt.parameters.index:=-1;
...
HILTREE_emptyNode(result1);
WITH lsps^ DO BEGIN
IF (X128MODOPAR = SUBJUNTIVO                              )                                                      THEN BEGIN
resultelt.sembonus:=0;
 resultelt.R:=72;
 lips.rulenr:=72;
 resultelt.parameters.index:=-1;
...
HILTREE_emptyNode(result1);
WITH lsps^ DO BEGIN
IF (X141GENEROPAR = MASC                                  ) AND (
X141NUMEROPAR = SINGULAR                              )                                                      THEN BEGIN
resultelt.sembonus:=0;
 resultelt.R:=89;
 lips.rulenr:=89;
 resultelt.parameters.index:=-1;
...
WITH lsps^ DO BEGIN
IF (X141GENEROPAR = MASC                                  ) AND (
X141NUMEROPAR = PLURAL                                )                                                      THEN BEGIN
resultelt.sembonus:=0;
 resultelt.R:=89;
 lips.rulenr:=89;
 resultelt.parameters.index:=-1;
...
helpresult1:=result1;
HILTREE_emptyNode(result1);
 IF X78SUPERPAR=PRESENTE THEN BEGIN
result2:=helpresult1;
...
HILTREE_addtoNode(p,result1);
 END;
END;
 IF X78SUPERPAR=PASADO THEN BEGIN
result2:=helpresult1;
WHILE NOT(HILTREE_IsEmptyNode(result2)) DO
 BEGIN
 HILTREE_TakeFromNode(p,result2);
...
resultelt.sembonus:=0;
 ...
 resultelt.parameters.subst:=ps.subst;
 resultelt.parameters.params:=lips;
 HILTREE_newhyperiltreerule(p,102,resultelt.parameters);
 HILTREE_storehypernodeelt(p,resultelt);
 HILTREE_AddToNode(p,result1);
appendresults(result1,result);
 END;
...
helpresult1:=result1;
HILTREE_emptyNode(result1);
 IF X383ADJUNCTPAR=RESAP THEN BEGIN
result2:=helpresult1;
WHILE NOT(HILTREE_IsEmptyNode(result2)) DO
 BEGIN
 HILTREE_TakeFromNode(p,result2);
...
HILTREE_addtoNode(p,result1);
 END;
END;
 IF X383ADJUNCTPAR=RESPP THEN BEGIN
result2:=helpresult1;
WHILE NOT(HILTREE_IsEmptyNode(result2)) DO
 BEGIN
 HILTREE_TakeFromNode(p,result2);
...
HILTREE_addtoNode(p,result1);
 END;
END;
 IF X383ADJUNCTPAR=SUBJCOMIT THEN BEGIN
result2:=helpresult1;
WHILE NOT(HILTREE_IsEmptyNode(result2)) DO
 BEGIN
 HILTREE_TakeFromNode(p,result2);
...
HILTREE_addtoNode(p,result1);
 END;
END;
 IF X383ADJUNCTPAR=OBJCOMIT THEN BEGIN
result2:=helpresult1;
WHILE NOT(HILTREE_IsEmptyNode(result2)) DO
 BEGIN
 HILTREE_TakeFromNode(p,result2);
...
HILTREE_addtoNode(p,result1);
 END;
END;
 IF X383ADJUNCTPAR=BENFACTNP THEN BEGIN
result2:=helpresult1;
WHILE NOT(HILTREE_IsEmptyNode(result2)) DO
 BEGIN
 HILTREE_TakeFromNode(p,result2);
...
HILTREE_addtoNode(p,result1);
 END;
END;
 IF X383ADJUNCTPAR=BENFACTPP THEN BEGIN
result2:=helpresult1;
WHILE NOT(HILTREE_IsEmptyNode(result2)) DO
 BEGIN
 HILTREE_TakeFromNode(p,result2);
...
HILTREE_addtoNode(p,result1);
 END;
END;
 IF X383ADJUNCTPAR=LOCADJUNCT THEN BEGIN
result2:=helpresult1;
WHILE NOT(HILTREE_IsEmptyNode(result2)) DO
 BEGIN
 HILTREE_TakeFromNode(p,result2);
...
HILTREE_addtoNode(p,result1);
 END;
END;
 IF X383ADJUNCTPAR=DIRADJUNCT THEN BEGIN
result2:=helpresult1;
WHILE NOT(HILTREE_IsEmptyNode(result2)) DO
 BEGIN
 HILTREE_TakeFromNode(p,result2);
...
HILTREE_addtoNode(p,result1);
 END;
END;
 IF X383ADJUNCTPAR=RESNP THEN BEGIN
result2:=helpresult1;
WHILE NOT(HILTREE_IsEmptyNode(result2)) DO
 BEGIN
 HILTREE_TakeFromNode(p,result2);
...
helpresult1:=result1;
HILTREE_emptyNode(result1);
 IF X384ADJUNCTPAR=RESAP THEN BEGIN
result2:=helpresult1;
WHILE NOT(HILTREE_IsEmptyNode(result2)) DO
 BEGIN
 HILTREE_TakeFromNode(p,result2);
...
HILTREE_addtoNode(p,result1);
 END;
END;
 IF X384ADJUNCTPAR=RESPP THEN BEGIN
result2:=helpresult1;
WHILE NOT(HILTREE_IsEmptyNode(result2)) DO
 BEGIN
 HILTREE_TakeFromNode(p,result2);
...
HILTREE_addtoNode(p,result1);
 END;
END;
 IF X384ADJUNCTPAR=SUBJCOMIT THEN BEGIN
result2:=helpresult1;
WHILE NOT(HILTREE_IsEmptyNode(result2)) DO
 BEGIN
 HILTREE_TakeFromNode(p,result2);
...
HILTREE_addtoNode(p,result1);
 END;
END;
 IF X384ADJUNCTPAR=OBJCOMIT THEN BEGIN
result2:=helpresult1;
WHILE NOT(HILTREE_IsEmptyNode(result2)) DO
 BEGIN
 HILTREE_TakeFromNode(p,result2);
...
HILTREE_addtoNode(p,result1);
 END;
END;
 IF X384ADJUNCTPAR=BENFACTNP THEN BEGIN
result2:=helpresult1;
WHILE NOT(HILTREE_IsEmptyNode(result2)) DO
 BEGIN
 HILTREE_TakeFromNode(p,result2);
...
HILTREE_addtoNode(p,result1);
 END;
END;
 IF X384ADJUNCTPAR=BENFACTPP THEN BEGIN
result2:=helpresult1;
WHILE NOT(HILTREE_IsEmptyNode(result2)) DO
 BEGIN
 HILTREE_TakeFromNode(p,result2);
...
HILTREE_addtoNode(p,result1);
 END;
END;
 IF X384ADJUNCTPAR=LOCADJUNCT THEN BEGIN
result2:=helpresult1;
WHILE NOT(HILTREE_IsEmptyNode(result2)) DO
 BEGIN
 HILTREE_TakeFromNode(p,result2);
...
HILTREE_addtoNode(p,result1);
 END;
END;
 IF X384ADJUNCTPAR=DIRADJUNCT THEN BEGIN
result2:=helpresult1;
WHILE NOT(HILTREE_IsEmptyNode(result2)) DO
 BEGIN
 HILTREE_TakeFromNode(p,result2);
...
HILTREE_addtoNode(p,result1);
 END;
END;
 IF X384ADJUNCTPAR=RESNP THEN BEGIN
result2:=helpresult1;
WHILE NOT(HILTREE_IsEmptyNode(result2)) DO
 BEGIN
 HILTREE_TakeFromNode(p,result2);
...
HILTREE_emptyNode(result1);
WITH lsps^ DO BEGIN
IF (X350SUPER = PRESENTE                                  )                                                      THEN BEGIN
resultelt.sembonus:=0;
 resultelt.R:=145;
 lips.rulenr:=145;
 resultelt.parameters.index:=-1;
...
HILTREE_emptyNode(result1);
WITH lsps^ DO BEGIN
IF (X350SUPER = PASADO                                    )                                                      THEN BEGIN
resultelt.sembonus:=0;
 resultelt.R:=134;
 lips.rulenr:=134;
 resultelt.parameters.index:=-1;
...
HILTREE_emptyNode(result1);
WITH lsps^ DO BEGIN
IF (X362SUPER = PRESENTE                                  )                                                      THEN BEGIN
resultelt.sembonus:=0;
 resultelt.R:=145;
 lips.rulenr:=145;
 resultelt.parameters.index:=-1;
...
HILTREE_emptyNode(result1);
WITH lsps^ DO BEGIN
IF (X362SUPER = PASADO                                    )                                                      THEN BEGIN
resultelt.sembonus:=0;
 resultelt.R:=134;
 lips.rulenr:=134;
 resultelt.parameters.index:=-1;
...
HILTREE_emptyNode(result1);
WITH lsps^ DO BEGIN
IF (X294SUPER = PRESENTE                                  )                                                      THEN BEGIN
resultelt.sembonus:=0;
 resultelt.R:=145;
 lips.rulenr:=145;
 resultelt.parameters.index:=-1;
...
HILTREE_emptyNode(result1);
WITH lsps^ DO BEGIN
IF (X294SUPER = PASADO                                    )                                                      THEN BEGIN
resultelt.sembonus:=0;
 resultelt.R:=134;
 lips.rulenr:=134;
 resultelt.parameters.index:=-1;
...
HILTREE_emptyNode(result1);
WITH lsps^ DO BEGIN
IF (X290SUPER = PRESENTE                                  )                                                      THEN BEGIN
resultelt.sembonus:=0;
 resultelt.R:=145;
 lips.rulenr:=145;
 resultelt.parameters.index:=-1;
...
HILTREE_emptyNode(result1);
WITH lsps^ DO BEGIN
IF (X290SUPER = PASADO                                    )                                                      THEN BEGIN
resultelt.sembonus:=0;
 resultelt.R:=134;
 lips.rulenr:=134;
 resultelt.parameters.index:=-1;
...
HILTREE_emptyNode(result1);
WITH lsps^ DO BEGIN
IF (X331SUPER = PRESENTE                                  )                                                      THEN BEGIN
resultelt.sembonus:=0;
 resultelt.R:=145;
 lips.rulenr:=145;
 resultelt.parameters.index:=-1;
...
HILTREE_emptyNode(result1);
WITH lsps^ DO BEGIN
IF (X331SUPER = PASADO                                    )                                                      THEN BEGIN
resultelt.sembonus:=0;
 resultelt.R:=134;
 lips.rulenr:=134;
 resultelt.parameters.index:=-1;
...
HILTREE_emptyNode(result1);
WITH lsps^ DO BEGIN
IF (X377NUMEROPAR = SINGULAR                              ) AND (
intequals1(X377ANTECEDENT)                            )                                                      THEN BEGIN
resultelt.sembonus:=0;
 resultelt.R:=164;
 lips.rulenr:=164;
 resultelt.parameters.index:=-1;
...
HILTREE_emptyNode(result1);
WITH lsps^ DO BEGIN
IF (X377NUMEROPAR = PLURAL                                ) AND (
intequals3(X377ANTECEDENT)                            )                                                      THEN BEGIN
resultelt.sembonus:=0;
 resultelt.R:=165;
 lips.rulenr:=165;
 resultelt.parameters.index:=-1;
...
helpresult1:=result1;
HILTREE_emptyNode(result1);
 IF X302NUMBERPAR=SINGULAR THEN BEGIN
result2:=helpresult1;
WHILE NOT(HILTREE_IsEmptyNode(result2)) DO
 BEGIN
 HILTREE_TakeFromNode(p,result2);
...
HILTREE_addtoNode(p,result1);
 END;
END;
 IF X302NUMBERPAR=PLURAL THEN BEGIN
result2:=helpresult1;
WHILE NOT(HILTREE_IsEmptyNode(result2)) DO
 BEGIN
 HILTREE_TakeFromNode(p,result2);
