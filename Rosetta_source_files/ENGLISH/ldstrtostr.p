...
STRING_constantempty(basetype);
END;
IF STRING_comparechars(typestr,'NEGTYPE',STRING_max)=0 THEN BEGIN
kind:=2;
STRING_constantempty(basetype);
END;
...
STRING_constantempty(basetype);
END;
IF STRING_comparechars(typestr,'ONETYPE',STRING_max)=0 THEN BEGIN
kind:=2;
STRING_constantempty(basetype);
END;
...
STRING_constantempty(basetype);
END;
IF STRING_comparechars(typestr,'POSSTYPE',STRING_max)=0 THEN BEGIN
kind:=2;
STRING_constantempty(basetype);
END;
IF STRING_comparechars(typestr,'PREDPOSTYPE',STRING_max)=0 THEN BEGIN
kind:=2;
STRING_constantempty(basetype);
END;
...
STRING_constantempty(basetype);
END;
IF STRING_comparechars(typestr,'WHCASETYPE',STRING_max)=0 THEN BEGIN
kind:=2;
STRING_constantempty(basetype);
END;
...
STRING_constantempty(basetype);
END;
IF STRING_comparechars(typestr,'ADVFORMATIONTYPE',STRING_max)=0 THEN BEGIN
kind:=3;
STRING_constantempty(basetype);
END;
...
STRING_constantempty(basetype);
END;
IF STRING_comparechars(typestr,'AUXTYPE',STRING_max)=0 THEN BEGIN
kind:=3;
STRING_constantempty(basetype);
END;
...
STRING_constantempty(basetype);
END;
IF STRING_comparechars(typestr,'COMPFORMATIONTYPE',STRING_max)=0 THEN BEGIN
kind:=3;
STRING_constantempty(basetype);
END;
IF STRING_comparechars(typestr,'COMPFORMTYPE',STRING_max)=0 THEN BEGIN
kind:=3;
STRING_constantempty(basetype);
END;
IF STRING_comparechars(typestr,'COMPLCATTYPE',STRING_max)=0 THEN BEGIN
kind:=3;
STRING_constantempty(basetype);
END;
...
STRING_constantempty(basetype);
END;
IF STRING_comparechars(typestr,'HEADTYPE',STRING_max)=0 THEN BEGIN
kind:=3;
STRING_constantempty(basetype);
END;
...
STRING_constantempty(basetype);
END;
IF STRING_comparechars(typestr,'INGFORMTYPE',STRING_max)=0 THEN BEGIN
kind:=3;
STRING_constantempty(basetype);
END;
...
STRING_constantempty(basetype);
END;
IF STRING_comparechars(typestr,'OBLCONTROLTYPE',STRING_max)=0 THEN BEGIN
kind:=3;
STRING_constantempty(basetype);
END;
IF STRING_comparechars(typestr,'PLURFORMTYPE',STRING_max)=0 THEN BEGIN
kind:=3;
STRING_constantempty(basetype);
END;
...
STRING_constantempty(basetype);
END;
IF STRING_comparechars(typestr,'SFORMTYPE',STRING_max)=0 THEN BEGIN
kind:=3;
STRING_constantempty(basetype);
END;
...
STRING_constantempty(basetype);
END;
IF STRING_comparechars(typestr,'THATDELTYPE',STRING_max)=0 THEN BEGIN
kind:=3;
STRING_constantempty(basetype);
END;
...
STRING_constantempty(basetype);
END;
IF STRING_comparechars(typestr,'POSITIONTYPE',STRING_max)=0 THEN BEGIN
kind:=4;
STRING_constantempty(basetype);
END;
...
STRING_appendchars(max,max,'tosubjectiveadj',STRING_max);
END;
...
STRING_constantempty(max);
STRING_appendchars(max,max,'postposition',STRING_max);
END;
...
END;
IF STRING_comparechars(typestr,'AUXSETTYPE',STRING_max)=0 THEN BEGIN
kind:=5;
STRING_constantempty(basetype);
STRING_appendchars(basetype,basetype,'auxtype',STRING_max);
STRING_constantempty(min);
STRING_appendchars(min,min,'aux',STRING_max);
STRING_constantempty(max);
STRING_appendchars(max,max,'pass',STRING_max);
END;
...
STRING_constantempty(max);
STRING_appendchars(max,max,'omegacase',STRING_max);
END;
...
END;
IF STRING_comparechars(typestr,'COMPFORMATIONSETTYPE',STRING_max)=0 THEN BEGIN
kind:=5;
STRING_constantempty(basetype);
STRING_appendchars(basetype,basetype,'compformationtype',STRING_max);
STRING_constantempty(min);
STRING_appendchars(min,min,'regcomp',STRING_max);
STRING_constantempty(max);
STRING_appendchars(max,max,'irrAdvComp',STRING_max);
END;
IF STRING_comparechars(typestr,'CONJCLASSESETTYPE',STRING_max)=0 THEN BEGIN
kind:=5;
STRING_constantempty(basetype);
...
STRING_constantempty(max);
STRING_appendchars(max,max,'14',STRING_max);
END;
...
STRING_constantempty(max);
STRING_appendchars(max,max,'Slets',STRING_max);
END;
...
STRING_constantempty(min);
STRING_appendchars(min,min,'femininegender',STRING_max);
STRING_constantempty(max);
STRING_appendchars(max,max,'omegagender',STRING_max);
END;
IF STRING_comparechars(typestr,'HEADSETTYPE',STRING_max)=0 THEN BEGIN
kind:=5;
STRING_constantempty(basetype);
STRING_appendchars(basetype,basetype,'headtype',STRING_max);
STRING_constantempty(min);
STRING_appendchars(min,min,'nounhead',STRING_max);
STRING_constantempty(max);
STRING_appendchars(max,max,'propernounhead',STRING_max);
END;
...
STRING_constantempty(min);
STRING_appendchars(min,min,'city',STRING_max);
STRING_constantempty(max);
STRING_appendchars(max,max,'othername',STRING_max);
END;
...
STRING_constantempty(min);
STRING_appendchars(min,min,'1',STRING_max);
STRING_constantempty(max);
STRING_appendchars(max,max,'3',STRING_max);
END;
IF STRING_comparechars(typestr,'PLURFORMSETTYPE',STRING_max)=0 THEN BEGIN
kind:=5;
STRING_constantempty(basetype);
STRING_appendchars(basetype,basetype,'plurformtype',STRING_max);
STRING_constantempty(min);
STRING_appendchars(min,min,'onlyplur',STRING_max);
STRING_constantempty(max);
STRING_appendchars(max,max,'singandplur',STRING_max);
END;
...
STRING_appendchars(max,max,'omegapol',STRING_max);
END;
IF STRING_comparechars(typestr,'POSITIONSETTYPE',STRING_max)=0 THEN BEGIN
kind:=5;
STRING_constantempty(basetype);
STRING_appendchars(basetype,basetype,'positiontype',STRING_max);
STRING_constantempty(min);
STRING_appendchars(min,min,'1',STRING_max);
STRING_constantempty(max);
...
STRING_constantempty(max);
STRING_appendchars(max,max,'rest',STRING_max);
END;
...
STRING_constantempty(min);
STRING_appendchars(min,min,'synASIFSENT',STRING_max);
STRING_constantempty(max);
STRING_appendchars(max,max,'synDONP_OPENINFSENT',STRING_max);
END;
...
STRING_constantempty(max);
STRING_appendchars(max,max,'notaux',STRING_max);
END;
...
IF (STRING_comparechars(cat,'BIRRPREF',STRING_max)=0) THEN
     STRING_appendchars(result,result,'BIRRPREFrecord',STRING_max);
...
IF (STRING_comparechars(cat,'GEN',STRING_max)=0) THEN
     STRING_appendchars(result,result,'GENrecord',STRING_max);
...
IF (STRING_comparechars(cat,'VARNP',STRING_max)=0) THEN
     STRING_appendchars(result,result,'NPrecord',STRING_max);
...
IF (STRING_comparechars(cat,'BPREFIX',STRING_max)=0) THEN
     STRING_appendchars(result,result,'BPREFIXrecord',STRING_max);
...
IF (STRING_comparechars(cat,'TOCAT',STRING_max)=0) THEN
     STRING_appendchars(result,result,'TOCATrecord',STRING_max);
...
IF (STRING_comparechars(cat,'THERE',STRING_max)=0) THEN
     STRING_appendchars(result,result,'THERErecord',STRING_max);
