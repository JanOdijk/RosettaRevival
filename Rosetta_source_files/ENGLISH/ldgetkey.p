...
BEGIN
   ...
   BBIGPRO: BEGIN
      ...
      END;
   BIRRPREF: BEGIN
         LDGETKEY_Get := t^.LS^.BIRRPREFfield^.KEY;
      END;
   CONJ: BEGIN
   ...
   EXCLAM: BEGIN
      ...
      END;
   GEN: BEGIN
         LDGETKEY_Get := t^.LS^.GENfield^.KEY;
      END;
   INDEFPRO: BEGIN
   ...
   POS: BEGIN
      ...
      END;
   BPREFIX: BEGIN
         LDGETKEY_Get := t^.LS^.BPREFIXfield^.KEY;
      END;
   SUBPREP: BEGIN
   ...
   RELPRO: BEGIN
      ...
      END;
   TOCAT: BEGIN
         LDGETKEY_Get := t^.LS^.TOCATfield^.KEY;
      END;
   THANAS: BEGIN
         LDGETKEY_Get := t^.LS^.THANASfield^.KEY;
      END;
   THERE: BEGIN
         LDGETKEY_Get := t^.LS^.THEREfield^.KEY;
      END;
   ADJPPROPVAR: BEGIN
   ...
   BWHPRO: BEGIN
      ...
      END;
   WHPRO: BEGIN
         LDGETKEY_Get := t^.LS^.WHPROfield^.KEY;
      END;
   SFCAT: BEGIN
...
BEGIN
   ...
   RELPRO: BEGIN
      ...
      END;
   TOCAT: BEGIN
         t^.LS^.TOCATfield^.KEY := k;
      END;
   THANAS: BEGIN
         t^.LS^.THANASfield^.KEY := k;
      END;
   THERE: BEGIN
         t^.LS^.THEREfield^.KEY := k;
      END;
   ADJPPROPVAR: BEGIN
