h50520
s 00093/00060/01315
d D 1.2 92/02/21 15:41:21 rous 2 1
c 
e
s 01375/00000/00000
d D 1.1 91/05/23 13:13:39 leermake 1 0
c date and time created 91/05/23 13:13:39 by leermake
e
u
U
f e 0
...
comp:
         C1:  (SFCATrec1.key = SFKs) and (NOUNrec1.geni = false) and
              (SUBNOUNrec1.lastaffix = noaffix)
         A1:  SUBNOUNrec2 := SUBNOUNrec1

decomp:
         C1:  (NOUNrec1.geni = false) and
              (SUBNOUNrec1.lastaffix = noaffix)
         A1:  SFCATrec1.key := SFKs
&
%VerbNOUNcomp
...
comp:
         C1:  (SFCATrec1.key = SFKs) 
              and (SUBNOUNrec1.lastaffix = noaffix)
