...
PROGRAM lexcomparser;

WITH LEXCOMRULES,
     LEXCOMGRAPHDEF,
     LEXCOMDECL;

 procedure lexcomparser_body(if1 : LEXCOMDECL_pconnectionnode; var if2 : LEXCOMDECL_plostree);
{*earley constants:} 
...
type 
     psurfgraphnodelist = ^LEXCOMDECL_surfgraphnodelist;
     plossurfnodelist = ^lossurfnodelist;
     lossurfnodelist = record
				next:plossurfnodelist;
				arg:LEXCOMDECL_surfgraphnodelist;
		       end;
     ...
     setofstrees =  record
   			j:INTEGER;
			first:LEXCOMDECL_plostree;
			last:LEXCOMDECL_plostree;
		    end;
     ...
     rulerec = record
			...
			completed:BOOLEAN;
			nextnodes:LEXCOMDECL_surfgraphnodelist;
			nexttops:LEXCOMDECL_syntcatset;
			nextcats:LEXCOMDECL_syntcatset
	       end;
     item = record
			cat:LEXCOMDECL_syntcat;
     ...
     reltreelist1 = record
			first:LEXCOMDECL_prsnode;
			last:LEXCOMDECL_prsnode
		   end;
     sentencelength = 0..maximumlength;
     grammarlength = 0..LEXCOMDECL_maxrnr;
...
var
    ...
    imax:sentencelength;
    topcats:LEXCOMDECL_syntcatset;
    topcat:array[1..LEXCOMDECL_maxrnr] of LEXCOMDECL_syntcat;
    initialitem:array[1..LEXCOMDECL_maxrnr] of pitem;
    libint:INTEGER;
    ...
    rsnodememory:array[1..maxrsnodes] of LEXCOMDECL_rsnode;
    itemmemory: array[1..maxitems] of item;
    setofitemsmemory: array[1..maxsetofitems] 
							of setofitems;
    lostreememory: array[1..maxlostrees] of LEXCOMDECL_lostree;
    ...
    lossurfnodememory: array[1..maxlossurfnodes] 
							of LEXCOMDECL_lossurfgraphnode;
    lossurfnodelistmemory: array[1..maxlossurfnodelists] 
							of lossurfnodelist;
    absent1:LEXCOMDECL_psurfgraph;
    newtop1:LEXCOMDECL_psinglesegmentlist;
    Sij:setofstrees;
    parentlist:array[1..LEXCOMDECL_maxrnr] of psetofitems;
...
procedure newrsnode(var p:LEXCOMDECL_prsnode);
begin
new(p)
end;
...
procedure newlostree(var p:LEXCOMDECL_plostree);
begin
new(p)
end;
...
procedure newlossurfnode(var p:LEXCOMDECL_plossurfgraphnode);
begin
new(p)
end;
...
procedure taketree(var stree1:LEXCOMDECL_psnode;var S1:setofstrees);
...
procedure appendtree(stree1:LEXCOMDECL_psnode;var S1:setofstrees);
{*appends stree1 at the end! of S1, if stree1 <> nil,
 *else S1 is not changed.}
var plostree1:LEXCOMDECL_plostree;
...
procedure appendnode(node1:LEXCOMDECL_psurfgraphnode;var S1:LEXCOMDECL_surfgraphnodelist);
{*puts node1 at the end! of S1, if node1 <> nil.}
var plossurfgraphnode1:LEXCOMDECL_plossurfgraphnode;
...
procedure appendnodelist(S1:LEXCOMDECL_surfgraphnodelist;var S2:LEXCOMDECL_surfgraphnodelist);
...
procedure initnodelist(var S1:LEXCOMDECL_surfgraphnodelist);
...
function stillnodes(var S1:LEXCOMDECL_surfgraphnodelist):BOOLEAN;
{*is true iff S1 is empty, i.e. if not S1.first=nil}
begin
...
procedure takenode(var node1:LEXCOMDECL_psurfgraphnode;var S1:LEXCOMDECL_surfgraphnodelist);
...
procedure copynodelist(var S1:LEXCOMDECL_surfgraphnodelist;var S2:LEXCOMDECL_surfgraphnodelist);
...
procedure appendsurfnodelist(var S1:LEXCOMDECL_surfgraphnodelist;
...
procedure takenodelist(var S1:LEXCOMDECL_surfgraphnodelist;var L1:listofsurfnodelists);
begin
...
procedure appendreltree(stree1:LEXCOMDECL_psnode;var RT1:reltreelist1);
var prsnode1:LEXCOMDECL_prsnode;
begin
newrsnode(prsnode1);
...
procedure searchgraph(graph1:LEXCOMDECL_psurfgraph;var node1:LEXCOMDECL_psurfgraphnode;
		var completed1:BOOLEAN;var nextnodes1:LEXCOMDECL_surfgraphnodelist;
                var nexttops1:LEXCOMDECL_syntcatset;var nextcats1:LEXCOMDECL_syntcatset);
...
var nextnodes2:LEXCOMDECL_surfgraphnodelist;
    result1,result2,result3,result4:LEXCOMDECL_syntcatset;
    node2:LEXCOMDECL_psurfgraphnode;
    cat1:LEXCOMDECL_syntcat;
    completed2:BOOLEAN;
...
procedure searchorread(graph1:LEXCOMDECL_psurfgraph;node2:LEXCOMDECL_psurfgraphnode;
		var completed1:BOOLEAN;var nextnodes1:LEXCOMDECL_surfgraphnodelist;
		var nexttops1:LEXCOMDECL_syntcatset;var nextcats1:LEXCOMDECL_syntcatset);
var node1:LEXCOMDECL_psurfgraphnode;
begin
...
with item1^.ruleinfo do
	...
	searchorread(LEXCOMDECL_surfgraph(rnr),nil,completed,
...
function sameitem(var item1:pitem;minpos:INTEGER;node1:LEXCOMDECL_psurfgraphnode;
...

function local(item1:pitem;stree1:LEXCOMDECL_psnode;IT:setofitems):setofitems;
...
var nextnodes1:LEXCOMDECL_surfgraphnodelist;
    node1:LEXCOMDECL_psurfgraphnode;
    result:setofitems;
    rnr:INTEGER;

function localsurfrule(item1:pitem;stree1:LEXCOMDECL_psnode;node1:LEXCOMDECL_psurfgraphnode):pitem;
var item2,item3,item4:pitem;
    n:LEXCOMDECL_nodeid;
    rnr,rnr2:INTEGER;
    parents1:setofitems;
    rnrset:array[0..LEXCOMDECL_maxrnr] of BOOLEAN;
    adoptedsons1,adoptedsons2:setofsetofstrees;
    setofstrees1,setofstrees2:setofstrees;
    history1,history2:listofsurfnodelists;
    surfgraphnodelist1,surfgraphnodelist2:LEXCOMDECL_surfgraphnodelist;

begin
LEXCOMDECL_assignstatus(false);
n:=node1^.n;
rnr:=item1^.ruleinfo.rnr;
if LEXCOMDECL_debug then write('->localsurfrule',rnr,'  idnr:',n);
LEXCOMRULES_rule(rnr,n,stree1,loccond);
if LEXCOMDECL_status then
	begin
	if LEXCOMDECL_debug then writeln('status true');
	if item1^.minpos=item1^.curpos then
		{*mark parents of initial items}
		begin
		rnr2:=0;
		while rnr2<>LEXCOMDECL_maxrnr do
			begin
			rnr2:=rnr2+1;
			rnrset[rnr2]:=false
			end;
	...
	if sameitem(item4,item1^.minpos,node1,IT)=false then
		...
		with item2^.ruleinfo do 
			...
			history:=history2;
			initnodelist(nextnodes);
			searchorread(LEXCOMDECL_surfgraph(rnr),node1,
...
else begin localsurfrule:=nil; if LEXCOMDECL_debug then writeln('status false') end
end;

begin{local}
if LEXCOMDECL_debug then writeln('->local',item1^.ruleinfo.rnr,'  minpos:',item1^.minpos);
inititemlist(result);
if stree1^.cat in item1^.ruleinfo.nextcats then
	...
	rnr:=0;
	while rnr<>LEXCOMDECL_maxrnr do
		begin
		rnr:=rnr+1;
...
var 
    node1:LEXCOMDECL_psurfgraphnode;
    surfgraphnodelist1:LEXCOMDECL_surfgraphnodelist;
    result:setofstrees;
...
var prsnode1,prsnode2,prsnode3:LEXCOMDECL_prsnode;
...
begin
if LEXCOMDECL_debug then writeln('->finalsurfrule');
LEXCOMDECL_assignstatus(false);
LEXCOMDECL_assignnewtop(nil);
inittreelist(S1);
LEXCOMRULES_rule(rnr,LEXCOMDECL_Hfinal,nil,globcond);
if LEXCOMDECL_status then
	begin
	saversnodes(RT1);
	while LEXCOMDECL_newtop<>nil do
		begin
                newtop1:=LEXCOMDECL_newtop;
		...
		LEXCOMDECL_assignnewtop(newtop1^.next)
		end
	end;
finalsurfrule:=S1
end;
...
procedure globalsurfrule(var setofstrees1:setofstrees;
		var surfgraphnodelist1:LEXCOMDECL_surfgraphnodelist;var RT1:reltreelist1;
							    var nsons:INTEGER);
var stree1:LEXCOMDECL_psnode;
    node1:LEXCOMDECL_psurfgraphnode;
begin
if LEXCOMDECL_debug then writeln('->globalsurfrule');
while stilltrees(setofstrees1) do
	...
	if LEXCOMDECL_status then
		begin
		LEXCOMDECL_assignstatus(false);
		LEXCOMRULES_rule(rnr,node1^.n,stree1,globcond);
		nsons:=nsons+1;
...

begin{final}
if LEXCOMDECL_debug then write('->final',item1^.ruleinfo.rnr);
inittreelist(result);
if item1^.ruleinfo.completed then
	...
	while stilltreelists(adoptedsons1) do
		...
		rnr:=item1^.ruleinfo.rnr;
		LEXCOMRULES_rule(rnr,LEXCOMDECL_Hinit,nil,globcond);
		nsons:=0;
...
if stilltrees(result)=false then if LEXCOMDECL_debug then writeln('status false');
final:=result
end;

...
{*}{*}{*}{*}{*}
{*}{*}{*}{*}{*}
procedure signalerror(i:INTEGER);
var stop:BOOLEAN;
    j:INTEGER;
    item1:pitem;
    stree1:LEXCOMDECL_psnode;
...
stop:=false;
j:=i;
while not(stop) and (j<>1) do
   begin
   j:=j-1;
   while stillitems(IT[j]) and not(stop) do
   	begin
   	takeitem(item1,IT[j]);
   	if item1^.cat=inputmodels then 
   		begin
   		while stilltreelists(item1^.adoptedsons) and not(stop) do
   			begin
   			taketreelist(setofstrees1,item1^.adoptedsons);
   			while stilltrees(setofstrees1) and not(stop) do
   				begin
   				taketree(stree1,setofstrees1);
   				if stree1^.cat=mcijfer then stop:=true
   				end;
writeln('ERROR in INPUTMODEL ',stree1^.mcijferfield^.mfield,
' or in the modelname just after it')
   			end
  		end;
   	if item1^.cat=outputmodel then 
   		begin
   		while stilltreelists(item1^.adoptedsons) and not(stop) do
   			begin
   			taketreelist(setofstrees1,item1^.adoptedsons);
...
writeln('ERROR in OUTPUTMODEL ',stree1^.mcijferfield^.mfield,
' or in the condition name just after it')
   			end
  		end;
   	if item1^.cat=condition then 
   		begin
   		while stilltreelists(item1^.adoptedsons) and not(stop) do
   			begin
   			taketreelist(setofstrees1,item1^.adoptedsons);
   			while stilltrees(setofstrees1) and not(stop) do
   				begin
   				taketree(stree1,setofstrees1);
   				if stree1^.cat=ccijfer then stop:=true
   				end;
writeln('ERROR in CONDITION ',stree1^.ccijferfield^.cfield,
' or in the condition/action name after it')
   			end
  		end;
   	if item1^.cat=action then 
   		begin
   		while stilltreelists(item1^.adoptedsons) and not(stop) do
   			begin
   			taketreelist(setofstrees1,item1^.adoptedsons);
   			while stilltrees(setofstrees1) and not(stop) do
   				begin
   				taketree(stree1,setofstrees1);
   				if stree1^.cat=acijfer then stop:=true
   				end;
writeln('ERROR in ACTION ',stree1^.acijferfield^.afield,
' or in the condition/action name after it')
   			end
  		end
   	end
...
while stilltreelists(setofSij) do
	...
	while stilltrees(S1) do
		...
		if LEXCOMDECL_debug then writeln('tree scanned');
		copyitemlist(I1,IT[i]);
...
var list1:LEXCOMDECL_psinglesegmentlist;
    i,j:INTEGER;
    stree1:LEXCOMDECL_psnode;
    connode1,connode2:LEXCOMDECL_pconnectionnode;
    Sij:setofstrees;
begin
...
i:=0;
if LEXCOMDECL_debug then writeln('imax determined:',imax); 
while i<>imax do
	begin
	{j:=i;
	while j<>imax do
   ...
   while connode1<>connode2 do
	...
	while list1<>nil do
		...
		stree1^.minpos:=i;stree1^.maxpos:=j;
                if LEXCOMDECL_debug then writeln('input i,j:',i,j,'cat:',ORD(stree1^.cat));
   		{*}if LEXCOMDECL_debug then 
     		    begin
     		    if stree1^.cat=charstring then 
	...
	connode1:=connode1^.next
   	...
   	while list1<>nil do
		...
		stree1^.minpos:=i;stree1^.maxpos:=imax;
                if LEXCOMDECL_debug then writeln('input i,j:',i,imax,'cat:',ORD(stree1^.cat));
   		{*}if LEXCOMDECL_debug then 
   		    begin
   	            if stree1^.cat=charstring then 
   		    writeln('charstring=',stree1^.charstringfield^.stringfield);
...
new(absent1);LEXCOMDECL_assignabsent(absent1);
i:=0;
usedparentlistindices:=[];
while i<>LEXCOMDECL_maxrnr do
   begin
   i:=i+1;
   usedparentlistindices:=usedparentlistindices + [i];
   end;
{initialize topcats and topcat[i]}
topcats:=[utt,models,inputmodels,outputmodel,model,nodedescription,reltreelist,
          capairs,action,condition,catname,catrecname,relname,pascal,tcijfer,
          mcijfer,ccijfer,acijfer,apestaart,comp,decomp,charstring,mucijfer];
topcat[1]:=utt;
topcat[2]:=models;
topcat[3]:=inputmodels;
topcat[4]:=outputmodel;
topcat[5]:=model;
topcat[6]:=nodedescription;
topcat[7]:=reltreelist;
topcat[8]:=capairs;
topcat[9]:=action;
topcat[10]:=condition;
topcat[11]:=catname;
topcat[12]:=catrecname;
topcat[13]:=relname;
topcat[14]:=pascal;
topcat[15]:=tcijfer;
topcat[16]:=mcijfer;
...
if LEXCOMDECL_debug then writeln('trees initialized');
initializeitems(imax);
LEXCOMRULES_recordsinit;
if LEXCOMDECL_debug then writeln('items initialized');
...
while i <> imax do
	begin
	if LEXCOMDECL_debug then writeln(i);
